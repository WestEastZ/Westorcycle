    ...
    return (
      <input
        ...
        className={cn(
          ...
          "flex w-full h-12 border-b px-5 py-5 text-sm focus:border-b-2 focus:border-stone-800 focus:outline-none bg-inherit disabled:cursor-not-allowed disabled:opacity-50 focus-visible:ring-offset-2 placeholder:text-white",
          className
        )}
        ref={ref}
        {...props}
